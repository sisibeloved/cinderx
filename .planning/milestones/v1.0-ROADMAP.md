...
**Plans:** 4 plans (2 for Phase 3A Quick Validation, 2 for Phase 3B Comprehensive Validation)

Plans:
- [ ] 03A-01-PLAN.md — 5-Benchmark Subset Automation (run_pyperf_subset.py, compare_lto_impact.py)
- [ ] 03A-02-PLAN.md — macOS Local Validation (macos_smoke_test.py, quick_validation.sh)
- [ ] 03B-01-PLAN.md — Docker ARM Environment (Dockerfile.arm, docker-compose.arm.yml)
- [ ] 03B-02-PLAN.md — CI/CD GitHub Actions (lto-performance.yml, ci.yml update, performance.md)
...
**Phase 3A 完成条件**:
- [ ] 03A-01: 5-benchmark automation scripts working
- [ ] 03A-01: LTO comparison with < 1% regression detection
- [ ] 03A-02: macOS smoke test completes in < 10 minutes
- [ ] 03A-02: Build time measurement and 30% threshold validation

**Phase 3B 完成条件**:
- [ ] 03B-01: Docker ARM environment builds successfully
- [ ] 03B-01: Full pyperformance suite runs on ARM
- [ ] 03B-02: GitHub Actions LTO workflow passes
- [ ] 03B-02: Performance documentation complete
