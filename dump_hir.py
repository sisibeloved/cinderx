...
# This file is named to match the pattern expected by isGeneratorsTreeIterCode
import time
import os
...
# Use "Node" class name to match isGeneratorsTreeIterCode pattern
class Node:
...
# cinderx.jit.force_compile(Node.__iter__)  # 注释掉，可能导致崩溃


def test_inline_iter():
    print("Testing InlineIter optimization...")
    print("Note: Using Node.__iter__ pattern for optimization detection")
